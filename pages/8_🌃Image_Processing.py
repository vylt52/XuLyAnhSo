    ...
    with col2:
        if chuong == "Chương 3: Biến đổi độ sáng và lọc trong không gian":
            xulyanh = st.selectbox(
                "Chọn phương pháp xử lí ảnh",
                (
                    "Negative",
                    "Logarit ảnh",
                    "Power",
    ...
    if chuong == "Chương 3: Biến đổi độ sáng và lọc trong không gian":
        if xulyanh == "Negative":
            ...
            if uploaded_file is not None:
                col2.image(uploaded_file, use_column_width=True, caption="Input")
                if execute:
                    image = Image.open(uploaded_file)
                    frame = np.array(image)
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c3.Negative(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
        ...
        if xulyanh == "Logarit ảnh":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c3.Logarit(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        if xulyanh == "Power":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c3.Power(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        ...
        if xulyanh == "Histogram Statistics":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c3.HistStat(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        ...
        if xulyanh == "SmoothingGauss":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        cv2.GaussianBlur(frame_gray, (43, 43), 7.0),
                        use_column_width=True,
                        caption="Output",
                    )
                if remove:
        ...
        if xulyanh == "Sharpen":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c3.Sharpen(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        if xulyanh == "Gradient":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c3.Gradient(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        ...
        if xulyanh == "Spectrum":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c4.Spectrum(frame_gray), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        ...
        if xylyanh == "Tạo nhiễu chuyển động":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c5.CreateMotionNoise(frame_gray),
                        use_column_width=True,
                        caption="Output",
                    )
                if remove:
        ...
        if xylyanh == "Gỡ nhiễu của ảnh có nhiều nhiễu":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    col2.image(
                        c5.DenoiseMotion(temp), use_column_width=True, caption="Output"
                    )
                if remove:
                    clear_uploaded_files(session_state)
                    st.experimental_rerun()
        ...
        if xulyanh == "Connected Component":
            ...
            if uploaded_file is not None:
                ...
                if execute:
                    ...
                    frame_gray = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
                    col2.image(
                        c9.ConnectedComponent(frame_gray),
                        use_column_width=True,
                        caption="Output",
                    )
                if remove:
